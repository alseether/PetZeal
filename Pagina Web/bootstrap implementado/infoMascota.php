<?php
 	...
 	echo '<form action="./actualizarPerfil.php?masc=true&id='.$masc["IDmascota"].'" method="post" enctype="multipart/form-data" class="col-lg-7 col-md-12 col-sm-12 form-horizontal">';
		...
		echo '<div class="form-group">';
			...
			echo '<div class="col-xs-10">';
				echo '<input type="text" id="inputSuccess" class="form-control" autocomplete maxlenght="50" placeholder="Escribe su nombre" name="nombre" value="'.$masc["Nombre"].'">';
			echo '</div>';
		echo '</div>';
		echo '<div class="form-group">';
			echo '<label class="col-xs-2 control-label" for="inputSuccess">Raza</label>';
			echo '<div class="col-xs-10">';
				echo '<input type="text" id="inputSuccess" class="form-control" autocomplete maxlenght="50" placeholder="Escribe su raza" name="raza" value="'.$masc["Raza"].'">';
			echo '</div>';
		echo '</div>';
		echo '<div class="form-group">';
			echo '<label class="col-xs-2 control-label" for="inputSuccess">Fecha de nacimiento</label>';
			echo '<div class="col-xs-10">';
				echo '<input type="date" id="inputSuccess" class="form-control" autocomplete maxlenght="50" placeholder="Escribe su fecha de nacimiento" name="edad" value="'.$masc["Nacimiento"].'">';
			echo '</div>';
		echo '</div>';
		echo '<div class="form-group">';
			echo '<label class="col-xs-2 control-label" for="inputSuccess">Descripción</label>';
			echo '<div class="col-xs-10">';
				echo '<textarea type="text" id="inputSuccess" class="form-control" autocomplete maxlenght="50" placeholder="Escribe una descripción" name="descripcion"> '.$masc["Descripcion"].'</textarea>';
			echo '</div>';
		echo '</div>';
